...
if(DEFINED ffmpeg_FIND_DEPENDENCY_NAMES)
  list(APPEND ffmpeg_FIND_DEPENDENCY_NAMES LibLZMA Iconv freetype BZip2 OpenJPEG openh264 Vorbis Opus libx264 libx265 libvpx libmp3lame fdk-aac WebP OpenSSL ZLIB ALSA libsvtav1 libaom-av1 dav1d)
  list(REMOVE_DUPLICATES ffmpeg_FIND_DEPENDENCY_NAMES)
else()
  set(ffmpeg_FIND_DEPENDENCY_NAMES LibLZMA Iconv freetype BZip2 OpenJPEG openh264 Vorbis Opus libx264 libx265 libvpx libmp3lame fdk-aac WebP OpenSSL ZLIB ALSA libsvtav1 libaom-av1 dav1d)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(ffmpeg_PACKAGE_FOLDER_RELEASE "/home/guo/.conan2/p/b/ffmpe404910eea822f/p")
...
set(ffmpeg_ffmpeg_avdevice_DEPENDENCIES_RELEASE ffmpeg::avutil ffmpeg::avfilter ffmpeg::swscale ffmpeg::avformat ffmpeg::avcodec ffmpeg::swresample ffmpeg::postproc ALSA::ALSA)
