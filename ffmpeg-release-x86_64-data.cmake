...
if(DEFINED ffmpeg_FIND_DEPENDENCY_NAMES)
  list(APPEND ffmpeg_FIND_DEPENDENCY_NAMES WebP pulseaudio ALSA xorg OpenSSL ZLIB vaapi vdpau dav1d)
  list(REMOVE_DUPLICATES ffmpeg_FIND_DEPENDENCY_NAMES)
else()
  set(ffmpeg_FIND_DEPENDENCY_NAMES WebP pulseaudio ALSA xorg OpenSSL ZLIB vaapi vdpau dav1d)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(ffmpeg_PACKAGE_FOLDER_RELEASE "/home/guo/.conan2/p/b/ffmpe9dd1a28ebfbc4/p")
...
set(ffmpeg_ffmpeg_avfilter_DEPENDENCIES_RELEASE ffmpeg::avutil ffmpeg::swscale ffmpeg::avformat ffmpeg::avcodec ffmpeg::swresample ffmpeg::postproc)
...
set(ffmpeg_ffmpeg_avformat_DEPENDENCIES_RELEASE ffmpeg::avutil ffmpeg::avcodec ffmpeg::swscale OpenSSL::SSL)
...
set(ffmpeg_ffmpeg_avcodec_DEPENDENCIES_RELEASE ffmpeg::avutil ffmpeg::swresample ZLIB::ZLIB libwebp::libwebp dav1d::dav1d)
